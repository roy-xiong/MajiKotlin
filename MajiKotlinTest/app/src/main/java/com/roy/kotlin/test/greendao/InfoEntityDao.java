...
public class InfoEntityDao extends AbstractDao<InfoEntity, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Label_search_url = new Property(17, String.class, "label_search_url", false, "LABEL_SEARCH_URL");
        public final static Property Notifications_url = new Property(18, String.class, "notifications_url", false, "NOTIFICATIONS_URL");
        public final static Property Organization_url = new Property(19, String.class, "organization_url", false, "ORGANIZATION_URL");
        public final static Property Organization_repositories_url = new Property(20, String.class, "organization_repositories_url", false, "ORGANIZATION_REPOSITORIES_URL");
        public final static Property Organization_teams_url = new Property(21, String.class, "organization_teams_url", false, "ORGANIZATION_TEAMS_URL");
        public final static Property Public_gists_url = new Property(22, String.class, "public_gists_url", false, "PUBLIC_GISTS_URL");
        public final static Property Rate_limit_url = new Property(23, String.class, "rate_limit_url", false, "RATE_LIMIT_URL");
        public final static Property Repository_url = new Property(24, String.class, "repository_url", false, "REPOSITORY_URL");
        public final static Property Repository_search_url = new Property(25, String.class, "repository_search_url", false, "REPOSITORY_SEARCH_URL");
        public final static Property Current_user_repositories_url = new Property(26, String.class, "current_user_repositories_url", false, "CURRENT_USER_REPOSITORIES_URL");
        public final static Property Starred_url = new Property(27, String.class, "starred_url", false, "STARRED_URL");
        public final static Property Starred_gists_url = new Property(28, String.class, "starred_gists_url", false, "STARRED_GISTS_URL");
        public final static Property User_url = new Property(29, String.class, "user_url", false, "USER_URL");
        public final static Property User_organizations_url = new Property(30, String.class, "user_organizations_url", false, "USER_ORGANIZATIONS_URL");
        public final static Property User_repositories_url = new Property(31, String.class, "user_repositories_url", false, "USER_REPOSITORIES_URL");
        public final static Property User_search_url = new Property(32, String.class, "user_search_url", false, "USER_SEARCH_URL");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"INFO_ENTITY\" (" + //
                ...
                "\"LABEL_SEARCH_URL\" TEXT," + // 17: label_search_url
                "\"NOTIFICATIONS_URL\" TEXT," + // 18: notifications_url
                "\"ORGANIZATION_URL\" TEXT," + // 19: organization_url
                "\"ORGANIZATION_REPOSITORIES_URL\" TEXT," + // 20: organization_repositories_url
                "\"ORGANIZATION_TEAMS_URL\" TEXT," + // 21: organization_teams_url
                "\"PUBLIC_GISTS_URL\" TEXT," + // 22: public_gists_url
                "\"RATE_LIMIT_URL\" TEXT," + // 23: rate_limit_url
                "\"REPOSITORY_URL\" TEXT," + // 24: repository_url
                "\"REPOSITORY_SEARCH_URL\" TEXT," + // 25: repository_search_url
                "\"CURRENT_USER_REPOSITORIES_URL\" TEXT," + // 26: current_user_repositories_url
                "\"STARRED_URL\" TEXT," + // 27: starred_url
                "\"STARRED_GISTS_URL\" TEXT," + // 28: starred_gists_url
                "\"USER_URL\" TEXT," + // 29: user_url
                "\"USER_ORGANIZATIONS_URL\" TEXT," + // 30: user_organizations_url
                "\"USER_REPOSITORIES_URL\" TEXT," + // 31: user_repositories_url
                "\"USER_SEARCH_URL\" TEXT);"); // 32: user_search_url
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, InfoEntity entity) {
        ...
        String label_search_url = entity.getLabel_search_url();
        if (label_search_url != null) {
            stmt.bindString(18, label_search_url);
        }
 
        String notifications_url = entity.getNotifications_url();
        if (notifications_url != null) {
            stmt.bindString(19, notifications_url);
        }
    ...
    public void readEntity(Cursor cursor, InfoEntity entity, int offset) {
        ...
        entity.setLabel_search_url(cursor.isNull(offset + 17) ? null : cursor.getString(offset + 17));
        entity.setNotifications_url(cursor.isNull(offset + 18) ? null : cursor.getString(offset + 18));
        entity.setOrganization_url(cursor.isNull(offset + 19) ? null : cursor.getString(offset + 19));
        entity.setOrganization_repositories_url(cursor.isNull(offset + 20) ? null : cursor.getString(offset + 20));
        entity.setOrganization_teams_url(cursor.isNull(offset + 21) ? null : cursor.getString(offset + 21));
        entity.setPublic_gists_url(cursor.isNull(offset + 22) ? null : cursor.getString(offset + 22));
        entity.setRate_limit_url(cursor.isNull(offset + 23) ? null : cursor.getString(offset + 23));
        entity.setRepository_url(cursor.isNull(offset + 24) ? null : cursor.getString(offset + 24));
        entity.setRepository_search_url(cursor.isNull(offset + 25) ? null : cursor.getString(offset + 25));
        entity.setCurrent_user_repositories_url(cursor.isNull(offset + 26) ? null : cursor.getString(offset + 26));
        entity.setStarred_url(cursor.isNull(offset + 27) ? null : cursor.getString(offset + 27));
        entity.setStarred_gists_url(cursor.isNull(offset + 28) ? null : cursor.getString(offset + 28));
        entity.setUser_url(cursor.isNull(offset + 29) ? null : cursor.getString(offset + 29));
        entity.setUser_organizations_url(cursor.isNull(offset + 30) ? null : cursor.getString(offset + 30));
        entity.setUser_repositories_url(cursor.isNull(offset + 31) ? null : cursor.getString(offset + 31));
        entity.setUser_search_url(cursor.isNull(offset + 32) ? null : cursor.getString(offset + 32));
     }
